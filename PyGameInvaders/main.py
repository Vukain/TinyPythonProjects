...
class AlienInvasion:
    """Main class to manage assets and behavior"""
    ...
    def _create_fleet(self):
        ...
        # Make an alien, spacing is equal to one alien
        alien = Alien(self)
    ...
    def _create_alien(self, alien_number, row_number):
        # Create an alien and place in in the group
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
    ...
    def _check_fleet_edges(self):
        """Reacts if any alien reaches screen edge"""
    ...
    def _check_aliens_bottom(self):
        """Check if any aliens reach bottom of the screen"""
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Remove any collided aliens and bullets
    ...
    def _ship_hit(self):
        """Respond to the ship getting hit by alien."""
